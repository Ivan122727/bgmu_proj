...
from my_research.db.collections.research import ResearchCollection
from my_research.db.collections.patient import PatientCollection
...
class DB:
    def __init__(self, mongo_uri: str, mongo_db_name: str):
        ...
        self.research_collection: ResearchCollection = ResearchCollection.from_mongo_db(
            motor_db=self.motor_db,
            pymongo_db=self.pymongo_db
        )
        self.collections.append(self.research_collection)

        self.patient_collection: PatientCollection = PatientCollection.from_mongo_db(
            motor_db=self.motor_db,
            pymongo_db=self.pymongo_db
        )
